...
## Frontend Setup (/farmhub-frontend)
...
The frontend currently points to the production API URL: https://farm-hub.onrender.com
...
All endpoints are prefixed with /api. Authentication is required except for /api/auth/**.
